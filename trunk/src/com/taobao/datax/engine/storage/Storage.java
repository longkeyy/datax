...
public abstract class Storage {
	...
	public class Statistics {
		...
		public String getSpeed(long byteNum, long seconds) {
			...
			long bypePerSecond = byteNum / seconds;
			long unit = bypePerSecond;
			if ((unit = bypePerSecond / 1000000) > 0) {
				return unit + "MB/s";
			} else if ((unit = bypePerSecond / 1000) > 0) {
				return unit + "KB/s";
			} else{
				return bypePerSecond + "B/s";
			}
		}
		...
		public String getLineSpeed(long lines, long seconds) {
			...
			long bypePerSecond = lines / seconds;
			return bypePerSecond + "lines/s";
		}
		...
		public String getPeriodState() {
			return String.format("stat:  %s speed %s|", this.storage.info(),
